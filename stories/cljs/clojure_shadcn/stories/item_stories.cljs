...
(defn ^:export Installation [] (r/as-element [helpers/installation-scene {:description "Current shadcn/ui composable item primitive." :npm-install "npm install @radix-ui/react-slot" :source-code (embed-source "clojure-shadcn.ui.components.item") :namespace-path "src/cljs/clojure_shadcn/ui/components/item.cljs" :filename "item.cljs"}]))
